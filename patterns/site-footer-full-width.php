<?php
/**
 * Title: Full width site footer
 * Slug: kenzie/site-footer-full-width
...
<!-- wp:navigation {"overlayMenu":"never","overlayBackgroundColor":"background","overlayTextColor":"foreground","align":"full","layout":{"type":"flex","justifyContent":"left","orientation":"horizontal"},"fontSize":"extra-small"} /-->
<!-- wp:pattern {"slug":"kenzie/footer-links-full-width"} /-->
</div>
<!-- /wp:group -->

...
<!-- wp:query {"query":{"perPage":"4","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list","columns":2},"align":"full","className":"kenzie-blog-layout","layout":{"inherit":true}} -->
<div class="wp-block-query alignfull kenzie-blog-layout"><!-- wp:heading {"fontSize":"small"} --><h2 class="has-small-font-size"><?php echo esc_html_x( 'Latest', 'sample content', 'kenzie' ); ?></h2>
<!-- /wp:heading -->

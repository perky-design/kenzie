...
?>
<!-- wp:pattern {"slug":"kenzie/circular-image-with-heading"} /-->
<!-- wp:spacer -->
<div style="height:100px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
<!-- wp:pattern {"slug":"kenzie/woo-featured-products-two-columns"} /-->
<!-- wp:spacer -->
<div style="height:100px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
...
<!-- wp:column {"width":"50%"} -->
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:heading {"fontSize":"small"} -->
...
<!-- /wp:column -->
<!-- wp:column {"width":"40%"} -->
<div class="wp-block-column" style="flex-basis:40%"><!-- wp:query {"query":{"perPage":"3","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list","columns":2},"align":"full","className":"kenzie-blog-layout","layout":{"inherit":true}} -->
<div class="wp-block-query alignfull kenzie-blog-layout">
<!-- wp:heading {"fontSize":"small"} --><h2 class="has-small-font-size"><?php echo esc_html_x( 'Latest', 'sample content', 'kenzie' ); ?></h2>
<!-- /wp:heading -->

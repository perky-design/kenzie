 ...
 * Slug: kenzie/featured-product-video-background
...
<div class="wp-block-column"><!-- wp:woocommerce/featured-product {"dimRatio":0,"editMode":false,"height":300} /-->
</div>
<!-- /wp:column -->
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'Add your custom product details here. To add the product video background, select the cover block and Add Media.', 'sample content', 'kenzie' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- wp:spacer {"height":"60px"} -->

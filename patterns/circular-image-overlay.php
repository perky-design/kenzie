...
<figure class="wp-block-image aligncenter size-large is-resized is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/girl-expressive.jpg' ) ); ?>" alt="<?php _e( 'Expressive girl', 'kenzie' ); ?>" width="550" height="550"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image alignright size-medium is-resized is-style-rounded is-kenzie-overlay"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/woman-curls.jpg' ) ); ?>" alt="<?php _e( 'Woman with curls', 'kenzie' ); ?>" width="300" height="300"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
